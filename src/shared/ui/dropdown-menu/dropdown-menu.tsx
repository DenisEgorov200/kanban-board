    ...
    <RadixDropdownMenu.Root>
      ...
      <RadixDropdownMenu.Portal>
        <RadixDropdownMenu.Content className="min-w-32 rounded-md bg-white shadow-md transition-colors hover:bg-gray-50">
          <RadixDropdownMenu.Item className="group relative flex cursor-pointer select-none items-center rounded bg-red-500 px-4 py-3 font-medium leading-none text-white outline-none data-[disabled]:pointer-events-none">
            Delete
